...
Article.create(vertical: 'Phrenology', is_cover_story: true, title: 'To Bodly Go', subtitle: 'Woah there split infinitive!', image_url: 'http://p1cdn01.thewrap.com/images/2014/10/Shatner.jpeg')
...
Article.create(vertical: 'Phrenology', title: 'Breaking Bad 2:', subtitle: 'Electric Boogaloo', image_url: 'http://sprudge.com/wp-content/uploads/2013/10/badger-skinny-pete.jpg')
Article.create(vertical: 'Phrenology', title: '27 1/2 things you won\'t believe are not butter', subtitle: 'we\'re running out of clickbait!!!', image_url: 'https://yt3.ggpht.com/-a02C8K8eCig/AAAAAAAAAAI/AAAAAAAAAAA/t7ShNOD3EQc/s900-c-k-no/photo.jpg')
...
Article.create(vertical: 'Astacology', is_cover_story: true, title: 'Has Donny Found his element yet?', subtitle: 'The world may never know...', image_url: 'http://i.imgur.com/VuVxuB8.jpg')
